...
// void CModel::Manipulability(const VectorXd &  q) {
// 	// Jacobian(7);
// 	m_manipulability_[0] = sqrt((_J_hand * _J_hand.transpose()).determinant());
// }

// void CModel::ManipulabilityJacobian() {
// 	m_J_manipulability_[0].resize(7 / 2);
// 	VectorXd q = _q;
// 	Manipulability(q);
...
void CModel::set_robot_config(){
	...
	_max_joint_torque.setConstant(15.0);
